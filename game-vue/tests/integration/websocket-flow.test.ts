...
describe('WebSocket Integration Flow', () => {
	...
	describe('Score Submission Flow', () => {
		...
		it('handles multiple players scoring', () => {
			...
			const players: Player[] = [
				...
				{id: '2', nickname: 'Player2', score: 950, framework: 'vue', timestamp: Date.now()},
				{id: '3', nickname: 'Player3', score: 900, framework: 'react', timestamp: Date.now()},
			];
		...
		it('allows same nickname to have multiple scores', () => {
			...
			const players: Player[] = [
				{id: '1', nickname: 'RetryPlayer', score: 800, framework: 'vue', timestamp: Date.now() - 2000},
				{id: '2', nickname: 'RetryPlayer', score: 950, framework: 'vue', timestamp: Date.now() - 1000},
				{id: '3', nickname: 'RetryPlayer', score: 1000, framework: 'vue', timestamp: Date.now()},
			];
			...
			const playerScores = leaderboardStore.players.filter((p) => p.nickname === 'RetryPlayer').map((p) => p.score);
	...
	describe('Real-time Updates', () => {
		it('updates all clients when new score arrives', () => {
			...
			const initialPlayers: Player[] = [{id: '1', nickname: 'Player1', score: 900, framework: 'vue', timestamp: Date.now()}];
			...
			const updatedPlayers: Player[] = [...initialPlayers, {id: '2', nickname: 'Player2', score: 950, framework: 'react', timestamp: Date.now()}];
	...
	describe('Data Consistency', () => {
		it('maintains score order after multiple updates', () => {
			...
			// First update
			leaderboardStore.updateLeaderboard([{id: '1', nickname: 'P1', score: 800, framework: 'vue', timestamp: Date.now()}]);

			// Second update with more players
			leaderboardStore.updateLeaderboard([
				{id: '1', nickname: 'P1', score: 800, framework: 'vue', timestamp: Date.now()},
				{id: '2', nickname: 'P2', score: 950, framework: 'react', timestamp: Date.now()},
			]);
			...
			leaderboardStore.updateLeaderboard([
				{id: '1', nickname: 'P1', score: 800, framework: 'vue', timestamp: Date.now()},
				{id: '2', nickname: 'P2', score: 950, framework: 'react', timestamp: Date.now()},
				{id: '3', nickname: 'P3', score: 900, framework: 'angular', timestamp: Date.now()},
			]);
