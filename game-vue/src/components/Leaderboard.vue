...
<template>
	<div class="max-w-4xl w-full mx-auto">
		<div class="rounded-xl p-6 shadow-2xl"
			...
			<div class="text-sm text-center text-gray-400">{{ leaderboardStore.players.length }} players</div>
			...
			<div v-if="leaderboardStore.currentPlayerRank"
				...
				<div class="flex justify-between items-center">
					<div>
						...
						<span class="text-2xl font-bold ml-2 text-primary"> #{{ leaderboardStore.currentPlayerRank }}
						</span>
					</div>
					<div>
			...
			<div class="overflow-hidden rounded-lg">
				<div v-if="leaderboardStore.topPlayers.length === 0"
					 class="text-center py-12 text-gray-500">No scores yet. Be the first! 🎯</div>
						...
						<tr v-for="(player, index) in leaderboardStore.topPlayers"
							...
							<td class="px-4 py-3 font-semibold">
								...
								<span v-if="player.nickname === leaderboardStore.currentNickname"
									  class="ml-2 text-xs text-primary"> (You) </span>
							</td>
