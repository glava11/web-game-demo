...
describe('leaderboardStore', () => {
	...
	it('updates leaderboard with new players', () => {
		...
		const players: Player[] = [
			{id: '1', nickname: 'Player1', score: 900, framework: 'vue', timestamp: Date.now()},
			{id: '2', nickname: 'Player2', score: 800, framework: 'react', timestamp: Date.now()},
		];
	...
	it('calculates current player rank correctly', () => {
		...
		const players: Player[] = [
			...
			{id: '2', nickname: 'Player2', score: 900, framework: 'vue', timestamp: Date.now()},
			{id: '3', nickname: 'Player3', score: 800, framework: 'vue', timestamp: Date.now()},
		];
	...
	it('returns null rank when player not in leaderboard', () => {
		...
		const players: Player[] = [{id: '1', nickname: 'Player1', score: 1000, framework: 'vue', timestamp: Date.now()}];
	...
	it('gets current player score correctly', () => {
		...
		const players: Player[] = [
			{id: '1', nickname: 'Player1', score: 1000, framework: 'vue', timestamp: Date.now()},
			{id: '2', nickname: 'Player2', score: 850, framework: 'vue', timestamp: Date.now()},
		];
